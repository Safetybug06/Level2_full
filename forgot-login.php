...
<div id="content">
		...
		<p>Please enter E-mail used for activation. <a href="forgot-userlogin.php" style="color: #058040;">I don't have an email, just a username</a></p>
	...
	<table <table class="login-res">
				<tr>
					<td><p>E-Mail:</p>   
                      <input id="email" name="email" type="text" class="text-field"  />
                    </td>
				</tr>
				<tr>
			<td><br/>
