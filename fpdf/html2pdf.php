...
{
    $html=strip_tags($html,"<b><u><i><a><img><p><br><strong><em><font><tr><blockquote><hr><td><th><tr><table><sup><h3><h2>"); //remove all unsupported tags
...
function OpenTag($tag, $attr)
{
    ...
    switch($tag){
		...
		case 'TH': // TD-BEGIN
            ...
            if( !empty($attr['HEIGHT']) ) $this->tdheight=100; //($attr['HEIGHT']/6);
