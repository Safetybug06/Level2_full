            ...
            <div class="col-xxl-12">
                <div class="total-visits-content card-box-style">
                    ...
                    <ul>
                        ...
                        <button type="button" id="add_new_admin1" class="btn btn-outline-success mb-1">Add New</button>
                ...
                email : ""
                    ...
                    <form  method="post" class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="password"  value="<?php $password = generateAdminPassword(); echo $password; ?>" readonly="readonly"  max="100" class="form-control" disabled>
                        </div>
...
<?php   if (isset($_SESSION["admin_type"]) && $_SESSION["admin_type"] == "main") {     ?>
    <div class="others-title">
       ...
       <form method="post" id="update_cc" class="row g-3 card-box-style">
        ...
        <div class="col-md-12">
            <button id="my-button" name="add" type="submit" value="Update" class="btn btn-primary">Update</button>
            <button id="reset-cc" name="add" type="button" value="Set to default" class="btn btn-success">Set to default</button>
        </div>
